...
module "infrastructure_base" {
  # infrastructure-base v0.1.41 — Grafana OIDC root_url, Renovate develop baseBranches, registry S3 fix
  source = "git::https://scm.maze.trading/data-platform/infrastructure-base.git?ref=v0.1.41"
